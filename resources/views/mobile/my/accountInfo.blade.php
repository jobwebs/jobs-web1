    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header esh-layout">
        <header class="mdl-layout__header mdl-layout__header--seamed esh-layout__header" id="esh-header">
            ...
            <div class="mdl-layout__header-row esh-layout__header-row esh-layout__header-row--has-button">
                <span class="mdl-layout__title esh-layout__title">基本信息</span>
            </div>
        </header>
            ...
            <form id="esh-person-info">
                <div class="esh-edit esh-edit-upload">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        ...
                        @else
                            <img src="{{asset('mobile/styles/default/images/default-img.png')}}" width="38px" height="38px"
                                 class="esh-upload-img"  id="upload-head--img"/>
                        @endif
                    ...
                    <div class="esh-check_inputs">
                        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="esh-male">
                            <input type="radio" id="esh-male" class="mdl-radio__button"
                                   @if($data['personinfo']->sex == 1 || ($data['personinfo']->sex != 1 && $data['personinfo']->sex != 2)) checked @endif
                                   name="sex" value="1" >
                ...
                <div class="esh-edit">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input mobile required" type="text"  name="tel"
                ...
                <div class="esh-edit">
                    ...
                    <div class="esh-select" id="esh-married-status">
                        ...
                        <select name="is_marry" class="esh-select-option">
                            ...
                            <option value="0" @if($data['personinfo']->is_marry != 1 && $data['personinfo']->is_marry != 2) selected @endif>保密</option>
                        </select>
                    </div>
                </div>
                <div class="esh-edit">
                ...
                <div class="esh-edit esh-textarea">
                    ...
                    <div class="esh-textarea--p" >
                        <textarea id="self-evaluation" placeholder="可选" name="self_evalu">{{$data['personinfo']->self_evalu}}</textarea>
                    </div>
                </div>
            </form>
            ...
            @if($data['type']==2)
             <form id="esh-company-info">
                 ...
                 <div class="esh-edit">
                     ...
                     <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                         <input class="mdl-textfield__input required mobile" type="text" name="etel"
                 ...
                 <div class="esh-edit-fb esh-form-sure">
                     <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="esh-save-cmpinfo" >
                         保存
                     </button>
                 </div>
             </form>
