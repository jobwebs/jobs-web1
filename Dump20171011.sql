...
CREATE TABLE `jobs_backup` (
  ...
  `workexp1` varchar(200) DEFAULT NULL,
  `workexp2` varchar(200) DEFAULT NULL,
  `workexp3` varchar(200) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`did`)
...
INSERT INTO `jobs_news` VALUES ('2', '发发发', 'hello', '3', '中心社', 'lol大赛国企', '的方式辅导是', '水电费', '36', '2017-10-10 23:33:23', '2017-10-10 15:33:23');
INSERT INTO `jobs_news` VALUES ('3', '鼎折3', '好机会', '2', '凤华网', '四川大学', '胜多负少的范德萨', '今天', '9', '2017-09-23 10:14:15', '2017-09-23 02:14:15');
INSERT INTO `jobs_news` VALUES ('4', '东京新闻', '东京', '2', '搜狐', '日本', 'www.html.picture', '日本', '67', '2017-10-10 23:33:20', '2017-10-10 15:33:20');
...
-- ----------------------------
INSERT INTO `jobs_position` VALUES ('1', '1', '123', '金辉', '百万年薪', '20000', '1', '1', '1', '1', '外企工作经验', '2', '200', '40', '2017-10-18 10:00:47', '1', '0', '12', '2017-09-03 09:46:15', '2017-10-10 15:34:18');
INSERT INTO `jobs_position` VALUES ('2', '3', '今天', '金石数据', 'IT行业', '200000', '1', '2', '1', '1', '国企', '1', '10', '30', '2017-10-14 09:46:04', '1', '1', '21', '2017-09-03 09:46:51', '2017-10-10 11:57:06');
...
INSERT INTO `jobs_users` VALUES ('26', 'jkjun0527', null, 'jkjun0527@foxmail.com', '$2y$10$iAOFL/wsEq2OrcrrHOWTSufRxG6/fF79pJE22xRDuZ1TK2y8JIxOS', '2', 'vZrqwh48xA2zjMSQnz6niynRvoDFFgbOV4szpMf1rx8RMfyG2VHaWlsZ3AjU', '0', '1', '0', '2017-09-18 14:00:08', '2017-10-10 22:06:10');
