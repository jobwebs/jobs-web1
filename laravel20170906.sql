...
CREATE TABLE `jobs_admininfo` (
  ...
  `name` varchar(100) NOT NULL DEFAULT 'admin' COMMENT '管理员名字',
  `permission` varchar(10) NOT NULL COMMENT '管理员权限',
...
-- ----------------------------
INSERT INTO `jobs_backup` VALUES ('1', '2', '0', '0', '0', '', '', '', '', '0', '2017-09-03 22:53:39', '0000-00-00 00:00:00');
...
-- ----------------------------
INSERT INTO `jobs_delivered` VALUES ('1', '1', '3', '1', null, '2017-09-03 22:52:21', '2017-09-03 22:52:21');
...
INSERT INTO `jobs_news` VALUES ('4', '东京新闻', '东京', '2', '搜狐', '日本', 'www.html.picture', '日本', '24', '2017-09-05 00:34:22', '2017-09-04 16:34:22');
...
CREATE TABLE `jobs_newsreview` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '评论修改时间',
  PRIMARY KEY (`rid`)
...
INSERT INTO `jobs_occupation` VALUES ('3', '1', '研发工程师', '2017-09-03 20:30:26', '0000-00-00 00:00:00');
...
-- ----------------------------
INSERT INTO `jobs_users` VALUES ('1', '23', '24242', '242342', 'gfgreeg', '1', 'fwsfsf', '0', '1', '0', '2017-09-04 20:35:25', '2017-09-04 20:37:33');
INSERT INTO `jobs_users` VALUES ('2', '12', 'e23423', '34234', 'ffwfw', '1', 'fsdfsdfsdfsd', '0', '1', '1', '2017-09-04 20:35:26', '2017-09-04 21:09:06');
INSERT INTO `jobs_users` VALUES ('3', '233', 'fsdf', 'fsdfs', 'gsfdfsd', '3', 'sdfsdfsd', '1', '0', '0', '2017-09-04 20:37:12', '2017-09-04 20:37:30');
